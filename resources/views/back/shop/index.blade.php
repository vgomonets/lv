...
@section('main')
  ...
  @include('back.partials.entete', ['title' => trans('back/blog.dashboard') . link_to_route('shop.create', trans('back/shop.add'), [], ['class' => 'btn btn-info pull-right']), 'icon' => 'pencil', 'fil' => trans('back/blog.posts')])
